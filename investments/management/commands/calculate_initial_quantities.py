...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            self.stdout.write(self.style.SUCCESS('Successfully calculated initial quantities'))
        
        except Exception as e:
            self.stdout.write(self.style.ERROR(f'Error calculating initial quantities: {str(e)}'))